...
class ReviewVectorizer(object):
    ...
    def __init__(self, review_vocab, rating_vocab):
        """
        :param review_vocab:-->class Vocabulary, maps words to integers
        :param rating_vocab:-->class Vocabulary, maps class labels to integers
        """
    ...
    def vectorize(self, review):
        """
        Create a collapsed one-hot vecotr for the review
        :param review:-->str, the review
        :return: --> np.ndarry, the collapsed one-hot encoding one_hot
        """
    ...
    def from_dataframe(cls, review_df, cutoff=25):
        ...
        :param review_df: (pd.DataFrame): the review dataset
    ...
    def to_serializable(self):
        ...
        """
        return {
            'review_vocab': self.rating_vocab.to_serializable(),
